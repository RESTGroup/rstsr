...
pub mod rstsr_funcs {
    ...
    pub use crate::tensor::manuplication::exports::{
        ...
        flip, flip_f, into_broadcast, into_broadcast_f, into_contig, into_contig_f, into_dim, into_dim_f, into_dyn,
        into_expand_dims, into_expand_dims_f, into_flip, into_flip_f, into_layout, into_layout_f, into_permute_dims,
        into_permute_dims_f, into_reverse_axes, into_shape, into_shape_assume_contig, into_shape_assume_contig_f,
