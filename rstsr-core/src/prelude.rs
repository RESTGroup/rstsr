...
pub mod rstsr_funcs {
    ...
    pub use crate::tensor::manuplication::exports::{
        ...
        to_contig_f, to_dim, to_dim_f, to_dyn, to_layout, to_layout_f, to_prefer, to_prefer_f, to_shape, to_shape_f,
        to_shape_with_args, to_shape_with_args_f, transpose, transpose_f,
    };
