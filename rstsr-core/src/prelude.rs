...
pub mod rstsr_funcs {
    ...
    pub use crate::tensor::manuplication::exports::{
        ...
        into_permute_dims, into_permute_dims_f, into_reverse_axes, into_shape, into_shape_f, into_shape_with_args,
        into_shape_with_args_f, into_squeeze, into_squeeze_f, into_swapaxes, into_swapaxes_f, into_transpose,
        into_transpose_f, permute_dims, permute_dims_f, reshape, reshape_f, reshape_with_args, reshape_with_args_f,
        ...
        to_layout_f, to_shape, to_shape_f, to_shape_with_args, to_shape_with_args_f, transpose, transpose_f,
    };
