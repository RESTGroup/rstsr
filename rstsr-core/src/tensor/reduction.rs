...
//! `argmax`, `count_nonzero`, `all`, `any`, `l2_norm`, `allclose`) are
//! generated by the local `trait_reduction!` macro; each family exposes
//! all-element (`_all`), axis-wise (`_axes`), and fallible (`_f`) variants.
