...
impl GGEVDriverAPI<T> for DeviceBLAS {
    unsafe fn driver_ggev(
        ...
        // We need to allocate temporary complex arrays, call LAPACKE, then split into components
        ...
        for i in 0..n {
            ...
            *alphai.add(i) = val_alpha.im;
            // For complex GGEV, beta is also complex, we store the real part only
            // (imaginary part is typically zero for standard problems)
