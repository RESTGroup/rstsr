...
use num::{Complex, Num};
use rstsr_dtype_traits::{DTypeIntoFloatAPI, ExtNum, ExtReal};
use std::ffi::c_void;
use std::ops::*;
...
pub trait BlasFloat:
    BlasScalar
    + DTypeIntoFloatAPI<FloatType = Self>
    + ComplexFloat<Real: ExtReal + DTypeIntoFloatAPI<FloatType = Self::Real>>
    + Send
    + Sync
